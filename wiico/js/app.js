(function wiico($,window){
    ...
    var requestTime = function(rd){
        ...
        //var weeks = ((((((later - now)/1000)/60)/60)/24)/7); //weeks
        //var months = ((((((later - now)/1000)/60)/60)/24)); //month
    ...
    $.ajax({
        url: 'https://api.themoviedb.org/3/search/movie?api_key=4650b6df4cd0d7388c64bd5a0823a95d&query=' + userInput + '&append_to_response=releases',
        method: 'GET',
        dataType: 'JSON',
    ...
    window.document.addEventListener("keypress", submitEnter)
